...
class GameMap:
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                if num_rooms == 0:
                    ...
                    #all rooms after the first get connected to the previous by a tunnel
                    (prev_x, prev_y) = rooms[num_rooms - 1].center()

                    # toss a coin for horizontal then vertical or vice versa
                    if randint(0, 1) == 1:
    ...
    def place_entities(self, room, entities, max_monsters_per_room):
        ...
        for i in range(number_of_monsters):
            #choose a random nlocation in the room
